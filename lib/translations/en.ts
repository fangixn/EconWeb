...
export const enResourceDescriptions: Record<string, string> = {
  ...
  "德国联邦银行": "Germany's central bank providing monetary policy and financial stability",
  "德国联邦统计局": "Federal Statistical Office providing official statistics for Germany",
  "德国经济研究所": "Leading German economic research institute for policy analysis",
  "德国联邦经济部": "Federal Ministry for Economic Affairs and Energy, German economic policy-making department",
  "德国对华政策研究所": "Specialized research on Chinese economy, risk assessment for German investment in China",
